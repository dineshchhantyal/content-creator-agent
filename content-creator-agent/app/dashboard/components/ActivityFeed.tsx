        ...
        <div className="relative pl-6 border-l border-gray-200 dark:border-gray-800 space-y-4">
          <div className="relative">
            ...
            <div className="text-sm">
              ...
              <p className="text-gray-600 dark:text-gray-400">You analyzed a new YouTube video</p>
            </div>
          </div>
          <div className="relative">
            ...
            <div className="text-sm">
              ...
              <p className="text-gray-600 dark:text-gray-400">You generated 3 new thumbnails</p>
            </div>
          </div>
          <div className="relative">
            ...
            <div className="text-sm">
              ...
              <p className="text-gray-600 dark:text-gray-400">You created your CreatorAI account</p>
            </div>
          </div>
        </div>
      </CardContent>
